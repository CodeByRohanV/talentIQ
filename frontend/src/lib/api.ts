...
export const resolveApiUrl = (configuredUrl: string | undefined): string => {
        ...
        for (const url of urls) {
            if (url.includes('*')) {
                ...
                if (regex.test(currentHost)) {
                    ...
                    // The Skillz Node.js API runs on the ROOT domain (skillztest.scaloz.com/api), not the subdomain.
