    ...
    try {
        ...
        if (!userId) {
            const newUser = await query(
                `INSERT INTO users (email, password_hash, full_name, must_change_password, is_verified, employee_id, manager_id, domain_id) 
                 VALUES ($1, $2, $3, true, true, $4, $5, $6) 
                 RETURNING id`,
                [email, hashedPassword, fullName, employeeId, managerId || null, domainId || null]
            );
